# Generated by Django 3.0.4 on 2020-04-17 07:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_valid', models.BooleanField(default=True)),
                ('status', models.CharField(choices=[('Unknown', 'Unknown'), ('Unassigned', 'Unassigned'), ('Available', 'Available'), ('InUse', 'In Use'), ('InTransit', 'In Transit'), ('SourceReserve', 'Source Reserve'), ('DestinationReserve', 'Destination Reserve')], default=webapp.models.Ventilator.Status['Unknown'], max_length=100)),
                ('serial_number', models.CharField(max_length=100)),
                ('monetary_value', models.IntegerField()),
                ('image', models.CharField(blank=True, max_length=200, null=True)),
                ('quality', models.IntegerField(blank=True, choices=[('Poor', 'Poor'), ('Fair', 'Fair'), ('Excellent', 'Excellent')], default=webapp.models.Ventilator.Quality['Poor'], null=True)),
